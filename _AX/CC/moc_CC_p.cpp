/****************************************************************************
** Meta object code from reading C++ file 'CC_p.h'
**
** Created: Wed Jun 29 11:16:53 2011
...
#error "The header file 'CC_p.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_CategoricalCompleter[] = {
    "CategoricalCompleter\0\0verifyPrefix()\0"
};
...
int CCTableView::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: setLineEdit((*reinterpret_cast< CCLineEdit*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 6;
    }
